...
- Add or update tests only when the task directly requires it.
- When requirements are unclear, incomplete, or ambiguous, you MUST ask questions.
- Output must always be in Japanese.
...
6. **Do not propose new tasks, improvements, or suggestions.**
   ...
   - All planning and task creation is handled by Codex.
